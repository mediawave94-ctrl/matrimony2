                    ...
                    <div className="flex-shrink-0">
                        <Link to="/" className="flex items-center gap-3 group">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xl md:text-2xl lg:text-4xl font-black tracking-tighter text-gray-900">Shisya Chettiar <span className="text-brand-maroon">Matrimony</span></span>
                            </div>
                        </Link>
                    </div>
