          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 text-center lg:text-left">
            ...
            <div className="flex-1 space-y-8 flex flex-col items-center lg:items-start">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-brand-maroon rounded-full flex items-center justify-center text-brand-gold shadow-lg ring-4 ring-brand-maroon/10">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-500 font-medium">Personalised matchmaking service</p>
                </div>
              </div>
